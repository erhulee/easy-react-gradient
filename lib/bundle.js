...
function _e(e, n, r, o) {
  ...
  if (E(e)) {
    ...
    var u = e(n);
    return "production" !== process.env.NODE_ENV && reactIs_2(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), _e(u, n, r, o);
  }
...
function Ye(e, t, n) {
  ...
  return O.displayName = v, (C = r$1.forwardRef(O)).attrs = N, C.componentStyle = I, C.displayName = v, C.shouldForwardProp = A, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : S, C.styledComponentId = g, C.target = o ? e.target : e, C.withComponent = function (e) {
    var r = t.componentId,
        o = function (e, t) {
      if (null == e) return {};
      var n,
...
var qe = function (e) {
  return function e(t, r, o) {
    if (void 0 === o && (o = w), !reactIs_3(r)) return D(1, String(r));
...
function translateCustom(source) {
    if (source == null)
        return "";
    let result = "";
...
function GradientText({ content, colors = ['rgba(0,0,0,1)', 'rgba(0,0,0,1)'], direction = '90 deg', custom, stroke, shadow }) {
    ...
    const Container = styled.div `
        position: relative;
    `;
    return (r$1.createElement(Container, null,
        r$1.createElement(Shadow, null, content),
        r$1.createElement(Content, null, content),
        r$1.createElement(Stroke, null, content)));
}

function createBorderWidth(width) {
    return width + 'px';
}

function fillConfigWidthDefault({ colors = ['(0,0,0,1)'], width = '2', direction = "horizon", radiusWidth = 10 }) {
    return {
        colors,
        width,
        direction,
...
function GradientBorder(Component, config) {
    const newConfig = fillConfigWidthDefault(config);
    ...
    return function (props) {
        return (r$1.createElement(Wrap, null,
            r$1.createElement(Component, Object.assign({}, props))));
    };
}
